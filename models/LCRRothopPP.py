...
class LCRRothopPP(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        """
        # Separate inputs: LCR
        input_left, input_target, input_right = inputs['asp']
        ...
        if self.training_phase:
            ...
            return {'asp': pred, 'embeddings': representation_left + representation_target_left + representation_target_right + representation_right}
    ...
    def get_embeddings_and_probabilities(self, inputs):
        self.training_phase = False
        output = self.call(inputs)
        self.training_phase = True
        return output['embeddings'], output['asp']