...
best_model.save_weights('/Users/basvanroozendaal/Downloads/DATA THESIS/Raw data/LCRRothopPP outputs restaurant 2016/AspGiniQuaNet.h5')
...
x_test_gini = create_trainings_data(all_data=test_results_lcr, sub_dataset_percentage=0.4, number_of_subdatasets=1000, sort_key=sort_key, subdataset_size=250)
y_test_true_gini = x_test_gini.pop('true_prevalence')

y_test_pred_gini = best_model.predict(x_test_gini)


kld_gini = kullback_leibler_divergence(y_test_true_gini, y_test_pred_gini)
rae_gini = relative_absolute_error(y_test_true_gini, y_test_pred_gini)
ae_gini = absolute_error(y_test_true_gini, y_test_pred_gini)
print(f'KLD: {kld_gini}, RAE: {rae_gini}, AE: {ae_gini}')
